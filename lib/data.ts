...
export const NUMBERS_DATA: NumberEntry[] = [
  { number: 1, word: 'One', emoji: '☀️', objects: '☀️', bgColor: 'bg-red-400' },
  { number: 2, word: 'Two', emoji: '⭐', objects: '⭐⭐', bgColor: 'bg-orange-400' },
  { number: 3, word: 'Three', emoji: '🎈', objects: '🎈🎈🎈', bgColor: 'bg-yellow-400' },
  { number: 4, word: 'Four', emoji: '🍎', objects: '🍎🍎🍎🍎', bgColor: 'bg-green-400' },
  { number: 5, word: 'Five', emoji: '🌸', objects: '🌸🌸🌸🌸🌸', bgColor: 'bg-teal-400' },
  { number: 6, word: 'Six', emoji: '🦋', objects: '🦋🦋🦋🦋🦋🦋', bgColor: 'bg-blue-400' },
  { number: 7, word: 'Seven', emoji: '🍭', objects: '🍭🍭🍭🍭🍭🍭🍭', bgColor: 'bg-purple-400' },
  { number: 8, word: 'Eight', emoji: '🐞', objects: '🐞🐞🐞🐞🐞🐞🐞🐞', bgColor: 'bg-pink-400' },
  { number: 9, word: 'Nine', emoji: '🌟', objects: '🌟🌟🌟🌟🌟🌟🌟🌟🌟', bgColor: 'bg-red-300' },
